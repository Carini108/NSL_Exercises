...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    Epot.open("output_epot_gas.dat",ios::app);
    Ekin.open("output_ekin_gas.dat",ios::app);
    Temp.open("output_temp_gas.dat",ios::app);
    Etot.open("output_etot_gas.dat",ios::app);
    Pres.open("output_pres_gas.dat",ios::app);
