...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    Epot.open("output_epot_solid.dat",ios::app);
    Ekin.open("output_ekin_solid.dat",ios::app);
    Temp.open("output_temp_solid.dat",ios::app);
    Etot.open("output_etot_solid.dat",ios::app);
    Pres.open("output_pres_solid.dat",ios::app);
