...
//Read input informations
  ReadInput.open("input_liquid.in");
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    Epot.open("output_epot_liquid.dat",ios::app);
    Ekin.open("output_ekin_liquid.dat",ios::app);
    Temp.open("output_temp_liquid.dat",ios::app);
    Etot.open("output_etot_liquid.dat",ios::app);
    Pres.open("output_pres_liquid.dat",ios::app);
